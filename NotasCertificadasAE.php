...
/* CONSULTA DE LAS NOTAS DEL 4to AÑO DEL ALUMNO mencion auxiliar docencia*/
$query_historial4 = "SELECT * FROM historial  where id_alumno=$cedula and grado=4 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de castellano
$query_materias41 = "SELECT * FROM materia where nombre like 'castellano y literatura' and grado=4 and mencion='Auxiliar Docente' ";
$materias41 = mysql_query($query_materias41, $conexion) or die(mysql_error());
$row_materias41 = mysql_fetch_assoc($materias41);

$query_nota41 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias41[id_materia]'";
...
//nombre y nota de la materia de ingles
$query_materias42 = "SELECT * FROM materia where nombre like 'ingles' and grado=5 and mencion='Auxiliar Docente' ";
$materias42 = mysql_query($query_materias42, $conexion) or die(mysql_error());
$row_materias42 = mysql_fetch_assoc($materias42);

$query_nota42 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias42[id_materia]'";
...
//nombre y nota de la materia de matematica
$query_materias43 = "SELECT * FROM materia where nombre like 'matematica' and grado=5 and mencion='Auxiliar Docente' ";
$materias43 = mysql_query($query_materias43, $conexion) or die(mysql_error());
$row_materias43 = mysql_fetch_assoc($materias43);

$query_nota43 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias43[id_materia]'";
...
//nombre y nota de la materia de cienciaa biologicas
$query_materias44 = "SELECT * FROM materia where nombre like 'cienciaa biologicas' and grado=5 and mencion='Auxiliar Docente' ";
$materias44 = mysql_query($query_materias44, $conexion) or die(mysql_error());
$row_materias44 = mysql_fetch_assoc($materias44);

$query_nota44 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias44[id_materia]'";
...
//nombre y nota de la materia de psicologia
$query_materias45 = "SELECT * FROM materia where nombre like 'psicologia' and grado=5 and mencion='Auxiliar Docente' ";
$materias45 = mysql_query($query_materias45, $conexion) or die(mysql_error());
$row_materias45 = mysql_fetch_assoc($materias45);

$query_nota45 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias45[id_materia]'";
...
//nombre y nota de la materia de historia de venezuela
$query_materias46 = "SELECT * FROM materia where nombre like 'historia de venezuela' and grado=5 and mencion='Auxiliar Docente' ";
$materias46 = mysql_query($query_materias46, $conexion) or die(mysql_error());
$row_materias46 = mysql_fetch_assoc($materias46);

$query_nota46 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias46[id_materia]'";
...
$query_materias47 = "SELECT * FROM materia where nombre like 'instruccion premilitar' and grado=5 and mencion='Auxiliar Docente' ";
$materias47 = mysql_query($query_materias47, $conexion) or die(mysql_error());
$row_materias47 = mysql_fetch_assoc($materias47);

$query_nota47 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias47[id_materia]'";
...
$query_materias48 = "SELECT * FROM materia where nombre like 'informatica' and grado=5 and mencion='Auxiliar Docente' ";
$materias48 = mysql_query($query_materias48, $conexion) or die(mysql_error());
$row_materias48 = mysql_fetch_assoc($materias48);

$query_nota48 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias48[id_materia]'";
...
//nombre y nota de la materia de METODOLOGIA DE LA INVEST.
$query_materias49 = "SELECT * FROM materia where nombre like 'METODOLOGIA DE LA INVEST.' and grado=5 and mencion='Auxiliar Docente' ";
$materias49 = mysql_query($query_materias49, $conexion) or die(mysql_error());
$row_materias49 = mysql_fetch_assoc($materias49);

$query_nota49 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias49[id_materia]'";
...
//nombre y nota de la materia de didactica
$query_materias410 = "SELECT * FROM materia where nombre like 'didactica' and grado=5 and mencion='Auxiliar Docente' ";
$materias410 = mysql_query($query_materias410, $conexion) or die(mysql_error());
$row_materias410 = mysql_fetch_assoc($materias410);

$query_nota410 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias410[id_materia]'";
...
//nombre y nota de la materia de educacion ambiental
$query_materias411 = "SELECT * FROM materia where nombre like 'educacion ambiental' and grado=5 and mencion='Auxiliar Docente' ";
$materias411 = mysql_query($query_materias411, $conexion) or die(mysql_error());
$row_materias411 = mysql_fetch_assoc($materias411);

$query_nota411 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias411[id_materia]'";
$nota411 = mysql_query($query_nota411, $conexion) or die(mysql_error());
$row_nota411 = mysql_fetch_assoc($nota411);

$nota411=$row_nota411["definitiva"];

//fin de la 11  materia

//nombre y nota de la materia de EDUC. FISICA Y DEPORTE
$query_materias412 = "SELECT * FROM materia where nombre like 'EDUC. FISICA Y DEPORTE' and grado=5 and mencion='Auxiliar Docente' ";
$materias412 = mysql_query($query_materias412, $conexion) or die(mysql_error());
$row_materias412 = mysql_fetch_assoc($materias412);

$query_nota412 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias412[id_materia]'";
$nota412 = mysql_query($query_nota412, $conexion) or die(mysql_error());
$row_nota412 = mysql_fetch_assoc($nota412);

$nota412=$row_nota412["definitiva"];
...
//nombre y nota de la materia de lecto escritura
$query_materias413 = "SELECT * FROM materia where nombre like 'lecto escritura' and grado=5 and mencion='Auxiliar Docente' ";
$materias413 = mysql_query($query_materias413, $conexion) or die(mysql_error());
$row_materias413 = mysql_fetch_assoc($materias413);

$query_nota413 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias413[id_materia]'";
$nota413 = mysql_query($query_nota413, $conexion) or die(mysql_error());
$row_nota413 = mysql_fetch_assoc($nota413);

$nota413=$row_nota413["definitiva"];

//fin de la 13  materia
...
/* CONSULTA DE LAS NOTAS DEL 5to AÑO DEL ALUMNO mencion auxiliar docencia*/
$query_historial5 = "SELECT * FROM historial  where id_alumno=$cedula and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de castellano
$query_materias51 = "SELECT * FROM materia where nombre like 'castellano y literatura' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de ingles
$query_materias52 = "SELECT * FROM materia where nombre like 'ingles' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de matematica
$query_materias53 = "SELECT * FROM materia where nombre like 'matematica' and grado=5 and mencion='Auxiliar Docente' ";
...
$query_materias54 = "SELECT * FROM materia where nombre like 'literatura venezolana' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de historia de venezuela
$query_materias55 = "SELECT * FROM materia where nombre like 'historia de venezuela' and grado=5 and mencion='Auxiliar Docente' ";
...
$query_materias56 = "SELECT * FROM materia where nombre like 'geografia economica' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de psicologia evolutiva
$query_materias57 = "SELECT * FROM materia where nombre like 'psicologia evolutiva' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de informatica
$query_materias58 = "SELECT * FROM materia where nombre like 'informatica' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de instruccion premilitar
$query_materias59 = "SELECT * FROM materia where nombre like 'instruccion premilitar' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de cultura indigena
$query_materias510 = "SELECT * FROM materia where nombre like 'cultura indigena' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de EDUC. FISICA Y DEPORTE
$query_materias511 = "SELECT * FROM materia where nombre like 'EDUC. FISICA Y DEPORTE' and grado=5 and mencion='Auxiliar Docente' ";
...
//nombre y nota de la materia de legislacion educativa
$query_materias512 = "SELECT * FROM materia where nombre like 'legislacion educativa' and grado=5 and mencion='Auxiliar Docente' ";
...
$query_materias513 = "SELECT * FROM materia where nombre like 'pre pasantia' and grado=5 and mencion='Auxiliar Docente' ";

$materias513 = mysql_query($query_materias513, $conexion) or die(mysql_error());
$row_materias513 = mysql_fetch_assoc($materias513);

$query_nota513 = "SELECT * FROM notas_materias where cod_hist='$row_historial5[cod_hist]' and id_materia='$row_materias513[id_materia]'";
$nota513 = mysql_query($query_nota513, $conexion) or die(mysql_error());
$row_nota513 = mysql_fetch_assoc($nota513);

$nota513=$row_nota513["definitiva"]; 
...
<title>Mencion Axiliar Docente</title>
<style type="text/css">
<!--
...
<form name="form1" method="get"  action="NotasCertificadasAE.php" />
<table width="826" border="0" align="center">
  
  <tr>
    <td width="820" height="1496" valign="top">
...
style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">07
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><h2 align="center" class="Estilo5" style='margin:0cm;margin-bottom:.0001pt'><span lang="es" xml:lang="es">SELLO DEL
            <o:p></o:p>
              ...
              <h2 align="center" style='margin:0cm;margin-bottom:.0001pt'><span class="Estilo5" lang="es" xml:lang="es">PLANTEL</span><span lang="es" xml:lang="es">
              <o:p></o:p>
              </span></h2></td>
        </tr>
...
style='font-size:8.0pt;mso-bidi-font-size:10.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">Este
  ...
  <tr valign="top">
    <td valign="top" height="1516"><p class="MsoNormal2"><b style='mso-bidi-font-weight:normal'><span
style='font-size:11.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">
      ...
      <table cellpadding="0" cellspacing="0" width="99%" >
        <tr valign="top">
          <td width="36%" height="81" valign="top"><![endif]>
              <div>
                <p class="MsoNormal222" align="center" style='text-align:center'><b style='mso-bidi-font-weight:normal'><span
    style='mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE"><img src="imagenes/mE.jpg" width="287" height="66" /></span></b></p>
                <p class="MsoNormal222"><b style='mso-bidi-font-weight:normal'><span
    style='mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE">
                  <o:p>&nbsp;</o:p>
                </span></b></p>
              </div>
          <![if !mso]></td>
          <td width="33%">&nbsp;</td>
          <td width="31%"><p class="MsoNormal2112" align="left" style='text-align:center'><b
    style='mso-bidi-font-weight:normal'><u><span style='font-size:
    8.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE">CERTIFICACI&Oacute;N
            DE CALIFICACIONES
            <o:p></o:p>
            </span></u></b></p>
              <p class="MsoNormal2112" align="left" style='text-align:center'><b
    style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;
    font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE">C&Oacute;DIGO DEL
                FORMATO: RR-DEA-03-03
                <o:p></o:p>
              </span></b></p>
            <p align="left" class="MsoNormal2112"><b style='mso-bidi-font-weight:normal'><span
    style='font-size:8.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:
    ES-VE' lang="ES-VE" xml:lang="ES-VE">I. Plan de Estudio: </span></b><u><span style='font-size:
    8.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE">EDUCACION
              MEDIA TECNICA </span></u><b style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
    ...
    ES-VE' lang="ES-VE" xml:lang="ES-VE">C&oacute;digo de Plan de Estudio: </span></b><u><span
    style='font-size:8.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:
    ES-VE' lang="ES-VE" xml:lang="ES-VE">___41000_____ </span></u><b style='mso-bidi-font-weight:
    normal'><span style='font-size:8.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
    mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE">
                <o:p></o:p>
              </span></b></p>
    ...
    ES-VE' lang="ES-VE" xml:lang="ES-VE">Menci&oacute;n:</span></b><u><span style='font-size:8.0pt;
    font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE"><span
    style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>AUXILIAR<span
    style='mso-spacerun:yes'>&nbsp; </span>DOCENTE_______</span></u><b
    style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;
    font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE">
                <o:p></o:p>
          </span></b></p></td>
...
style='font-size:11.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">
      ...
      <p class="MsoNormal4" style='text-align:justify'></p>
      <p class="MsoNormal4"><span style='font-size:9.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">
        <o:p>&nbsp;</o:p>
      </span></p>
      <table class="MsoNormalTable" border="1" cellspacing="0" cellpadding="0"
 style='border-collapse:collapse;border:none;mso-border-alt:solid windowtext .5pt;
 ...
 mso-border-insidev:.5pt solid windowtext'>
  ...
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-bottom-alt:solid windowtext .5pt;mso-border-right-alt:solid windowtext .5pt;
  padding:0cm 3.5pt 0cm 3.5pt;height:13.1pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-size:11.0pt;mso-bidi-font-size:10.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">IV. Planteles donde curs&oacute; estos
            estudios:</span></b><span style='font-size:11.0pt;mso-bidi-font-size:
  10.0pt' lang="es" xml:lang="es">
  ...
  solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:13.1pt'><h2 style='margin:0cm;margin-bottom:.0001pt'><span lang="es" xml:lang="es">N&deg;
          ...
          <td width="154" valign="top" style='width:115.4pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:13.1pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Nombre del Plantel
            <o:p></o:p>
          </span></b></p></td>
  ...
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:13.1pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Nombre
            del Plantel
            <o:p></o:p>
          </span></b></p></td>
  ...
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:13.1pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">2
            <o:p></o:p>
          </span></b></p></td>
  ...
  &quot;Times New Roman&quot;' lang="es" xml:lang="es">***
        ...
        <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes;height:13.1pt'>
          <td width="27" valign="top" style='width:19.9pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 3.5pt 0cm 3.5pt;height:13.1pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">1
            <o:p></o:p>
          </span></b></p></td>
  ...
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:13.1pt'><p class="MsoNormal4" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">AM
            <o:p></o:p>
          </span></p></td>
          <td width="38" valign="top" style='width:1.0cm;border-top:none;border-left:none;
  ...
  &quot;Times New Roman&quot;' lang="es" xml:lang="es">***
      ...
      <p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
style='font-size:2.0pt;mso-bidi-font-size:10.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
        <o:p>&nbsp;</o:p>
      </span></b></p>
 ...
 mso-border-insidev:.5pt solid windowtext'>
        <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;page-break-inside:avoid'>
          <td colspan="8" valign="top" bordercolor="#FFFFFF" style='width:414.4pt;border:none;
  padding:0cm 3.5pt 0cm 3.5pt'><h6 align="left" style='margin-left:0cm;text-align:left;text-indent:0cm;
  mso-list:none;tab-stops:35.4pt'><span lang="es" xml:lang="es">V. Pensum de Estudio:
            <o:p></o:p>
          </span></h6></td>
          <td width="14" rowspan="45" valign="top" bordercolor="#FFFFFF" style='width:8.0pt;border:none;border-right:solid windowtext 1.0pt;
  mso-border-right-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
              <o:p>&nbsp;</o:p>
          </span></b></p>            <p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
              <o:p>&nbsp;</o:p>
          </span></b></p>          <p class="MsoNormal4" align="center" style='text-align:center'><b
  ...
  style='mso-list:Ignore'>VI.<span style='font:7.0pt &quot;Times New Roman&quot;'>&nbsp;&nbsp;&nbsp; </span></span></span>
        ...
        <tr style='mso-yfti-irow:1;page-break-inside:avoid'>
          <td width="223" style='width:166.55pt;border:solid windowtext 1.0pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">A&ntilde;o
            o Grado: </span></b><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es"><span
  style='mso-spacerun:yes'>&nbsp;</span>4&ordm; A&Ntilde;O <b style='mso-bidi-font-weight:normal'>
                    <o:p></o:p>
                </b></span></p></td>
          <td colspan="2" style='width:106.3pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  ...
  mso-border-left-alt:solid windowtext .5pt;mso-border-top-alt:solid windowtext .5pt;
  mso-border-left-alt:solid windowtext .5pt;mso-border-right-alt:solid windowtext .5pt;
  padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Plantel
            <o:p></o:p>
          </span></b></p></td>
  ...
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Apellidos
            y Nombres del Director(a):
            <o:p></o:p>
          </span></b></p></td>
        ...
        <tr style='mso-yfti-irow:2;page-break-inside:avoid;height:5.95pt'>
          <td width="223" style='width:166.55pt;border:solid windowtext 1.0pt;border-top:
  none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 3.5pt 0cm 3.5pt;height:5.95pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Asignaturas
            <o:p></o:p>
          </span></b></p></td>
          <td width="48" style='width:35.4pt;border-top:none;border-left:none;border-bottom:
  solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
  solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:5.95pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;
  font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">En
            N&deg;
                    <o:p></o:p>
  ...
  solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
  solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:5.95pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">En
            letras
            <o:p></o:p>
          </span></b></p></td>
  ...
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;height:5.95pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Mes
            <o:p></o:p>
          </span></b></p></td>
  ...
  mso-border-left-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-right-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt;
  height:5.95pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">N&deg;
                      <o:p></o:p>
          </span></b></p></td>
        ...
        <tr style='mso-yfti-irow:3;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">CASTELLANO    Y LITERATURA</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">F
            <o:p></o:p>
          </span></b></p></td>
          <td colspan="2" valign="top" style='width:1.0cm;border-top:none;
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><span
style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">07
            <o:p></o:p>
          </span></p></td>
          <td width="72" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="left" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo $ano1; ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="59" valign="top" style='width:42.35pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;background:white;mso-background-themecolor:background1;
  padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
            <o:p></o:p>
          </span></p></td>
          <td width="179" valign="top" style='width:133.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" style='margin-left:35.4pt;text-indent:-35.4pt'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;'
  lang="es" xml:lang="es">Pbro.
            Lic. F&eacute;lix A. Brito M.
            <o:p></o:p>
          </span></p></td>
        ...
        <tr style='mso-yfti-irow:4;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">INGLES</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">N&uacute;mero
        ...
        <tr style='mso-yfti-irow:5;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">MATEM&Aacute;TICA</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'>07</p></td>
          <td width="72" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4"><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">V-</span><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;;
  mso-ansi-language:PT-BR' lang="PT-BR" xml:lang="PT-BR">6.307.017</span><span style='font-family:
  &quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
        ...
        <tr style='mso-yfti-irow:6;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">CIENCIAS    BIOLOGICAS</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Firma:
        ...
        <tr style='mso-yfti-irow:7;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">PSICOLOGIA</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  border-left:none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
              <o:p>&nbsp;</o:p>
          </span></b></p></td>
        ...
        <tr style='mso-yfti-irow:8;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">HISTORIA    DE VENEZUELA</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
        ...
        <tr style='mso-yfti-irow:9;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">INSTRUCCI&Oacute;N    PREMILITAR</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
          ...
          <td width="179" rowspan="12" style='width:133.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><h2 align="center" class="Estilo5" style='margin:0cm;margin-bottom:.0001pt'><span lang="es" xml:lang="es">SELLO DEL
            <o:p></o:p>
        ...
        <tr style='mso-yfti-irow:10;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">INFORMATICA</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
        ...
        <tr style='mso-yfti-irow:11;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">METODOLOGIA    DE LA INVEST.</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
        ...
        <tr style='mso-yfti-irow:12;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">DIDACTICA</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
        ...
        <tr style='mso-yfti-irow:12;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">EDUCACI&Oacute;N&nbsp; AMBIENTAL</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo $nota411; ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="95" valign="top" style='width:70.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo nombre($nota411); ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="38" valign="top" style='width:1.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
        ...
        <tr style='mso-yfti-irow:12;page-break-inside:avoid'>
          <td valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">EDUC.    F&Iacute;SICA Y DEPORTE</span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo $nota412; ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="95" valign="top" style='width:70.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo nombre($nota412); ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="38" valign="top" style='width:1.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
        ...
        <tr style='mso-yfti-irow:12;page-break-inside:avoid'>
          <td valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">LECTO    ESCRITURA </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo $nota413; ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="95" valign="top" style='width:70.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo nombre($nota413); ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="38" valign="top" style='width:1.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">***
        ...
        <tr style='mso-yfti-irow:15;page-break-inside:avoid'>
          <td width="223" style='width:166.55pt;border:solid windowtext 1.0pt;border-top:
  none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4"><b style='mso-bidi-font-weight:normal'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">A&ntilde;o
            o Grado:<span style='mso-spacerun:yes'>&nbsp; </span></span></b><span
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-right-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Plantel
            <o:p></o:p>
          </span></b></p></td>
  ...
  solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;mso-border-top-alt:
  solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;
  font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">En
            N&deg;
                    <o:p></o:p>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><span style="font-family:&quot;Arial&quot;,&quot;sans-serif&quot;"><?php echo  $ano2; ?></span></p></td>
          <td width="59" valign="top" style='width:42.35pt;border:solid windowtext 1.0pt;
  border-left:none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:
  solid windowtext .5pt;background:white;mso-background-themecolor:background1;
  padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><span
  ...
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><span
  style='font-size:8.0pt;mso-bidi-font-size:10.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Para efectos de su validez
            <o:p></o:p>
            </span></p>
              <p class="MsoNormal4" align="center" style='text-align:center'><span class="GramE4"><span style='font-size:8.0pt;mso-bidi-font-size:10.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;'
  lang="es" xml:lang="es">a</span></span><span
  style='font-size:8.0pt;mso-bidi-font-size:10.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es"> nivel estadal.</span><b
  ...
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
        ...
        <tr style='mso-yfti-irow:20;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">LITERATURA    VENEZOLANA </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><span style="font-family:&quot;Arial&quot;,&quot;sans-serif&quot;"><?php echo  $ano2; ?></span><span lang="es" xml:lang="es">
              <o:p></o:p>
          </span></p></td>
          <td width="59" valign="top" style='width:42.35pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">01
        ...
        <tr style='mso-yfti-irow:21;page-break-inside:avoid'>
          <td valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">GEOGRAFIA    ECONOMICA </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'>&nbsp;</td>
        ...
        <tr style='mso-yfti-irow:21;page-break-inside:avoid'>
          <td valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">PSICOLOGIA    EVOLUTIVA </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">Director(a):
        ...
        <tr style='mso-yfti-irow:25;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">CULTURA    INDIGENA </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
        ...
        <tr style='mso-yfti-irow:26;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">EDUCAC.&nbsp; FISICA Y DEPORTE </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">N&uacute;mero
        ...
        <tr style='mso-yfti-irow:27;page-break-inside:avoid'>
          <td width="223" valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">LEGISLACION    EDUCATIVA </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  ...
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">
        ...
        <tr style='mso-yfti-irow:27;page-break-inside:avoid'>
          <td valign="top" style='width:166.55pt;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  background:white;mso-background-themecolor:background1;padding:0cm 3.5pt 0cm 3.5pt'><span class="Estilo4">PRE-    PASANTIA </span></td>
          <td width="48" valign="top" style='width:35.4pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo $nota513; ?>
                    <o:p></o:p>
          </span></p></td>
          <td width="95" valign="top" style='width:70.9pt;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal" align="center" style='text-align:center'><span
  style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es"><?php echo nombre($nota513); ?>
                    <o:p></o:p>
          </span></p></td>
          <td valign="top" style='width:1.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  ...
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt'>&nbsp;</td>
          <td valign="top" style='width:133.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'>&nbsp;</td>
        </tr>
  ...
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">N&deg;
          ...
          <td width="179" rowspan="8" style='width:133.95pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 3.5pt 0cm 3.5pt'><p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  ...
  font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
              ...
              <p class="MsoNormal4" align="center" style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;
  mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">ZONA EDUCATIVA
                <o:p></o:p>
            </span></b></p></td>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
  background1;padding:0cm 3.5pt 0cm 3.5pt;height:7.6pt'>&nbsp;</td>
          <td width="59" valign="top" style='width:42.35pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;background:white;mso-background-themecolor:
...
mso-bidi-font-family:&quot;Times New Roman&quot;' lang="es" xml:lang="es">
        <o:p>&nbsp;</o:p>
      </span></b>VIII.&nbsp; Programas Aprobados de Educaci&oacute;n para el  Trabajo: GRADO / NOMBRE / HORAS ALUMNO SEM.</p>
