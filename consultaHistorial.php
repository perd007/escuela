...
<form method=post name=form1 onsubmit='return validar()' action=".$editFormAction.">
  <table class='border' width=300 border=1 align=center>
  <tr bgcolor='#b50f0f' >
      <td colspan='2' >
	  <div class='Estilo2' align='center'>Consulta de Historial</div>
	  </td>
...
mysql_select_db($database_conexion, $conexion);
$query_hist = "SELECT * FROM historial where id_alumno=$cedula order by ano_escolar";
...
echo "
<table class='border' width=550 border=0 cellspacing='0' cellpadding='4' > 
<tr bgcolor=#b50f0f>
    <th colspan=8 class='Estilo1' align=center >Consulta de Historiales</th>
  </tr>
  <tr>
    <th colspan=8 class='Estilo3' scope=col>".$row_alumnos['cedula']." - ".$row_alumnos['nombre']." ".$row_alumnos['apellido']."</th>
  </tr>
  <tr>
    <td width=65 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Año</strong></div></td>
    <td width=65 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Grado</strong></div></td>
    <td width=10 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Seccion</strong></div></td>
	<td width=50 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Cargar</strong></div></td>
    <td width=50 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Cambiar</strong></div></td>
    <td width=15 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Opcion</strong></div></td>
    <td width=15 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Opcion</strong></div></td>
	<td width=15 bgcolor=#b50f0f><div align=center class=Estilo1><strong>Opcion</strong></div></td>
  </tr>
 ...
 switch ($row_hist['grado']){
    ...
    echo "<tr class='Estilo3'>";
      ...
      <td bgcolor=".$color."><div align=center>".$row_hist['seccion']."</div></td>
	   <td bgcolor=".$color."><div align=center><span class=Estilo1><a href='principal.php?link=link6&cedula=$cedula&hist=$row_hist[cod_hist]&val=1'>Notas</a></span></div></td>
	   <td bgcolor=".$color."><div align=center><span class=Estilo1><a href='principal.php?link=link60&cedula=$cedula&hist=$row_hist[cod_hist]&val=1'>Notas</a></span></div></td>
      <td bgcolor=".$color."><div align=center><span class=Estilo1><a href='principal.php?id=$row_hist[cod_hist]&link=link521&cedula=$cedula'>Detalle</a></span></div></td>
      <td bgcolor=".$color."><div align=center><span class=Estilo1><a href='principal.php?id=$row_hist[cod_hist]&link=link522&cedula=$cedula'>Modificar</a></span></div></td>
      <td bgcolor=".$color."><div align=center><span class=Estilo1><a onClick='return validar()' href='principal.php?id=$row_hist[cod_hist]&link=link523'>Eliminar</a></span></div></td>
       </tr>"; 
  ...
  <tr><td><br></td></tr>
  <tr>
  <td colspan=8  bgcolor=#b50f0f><div align=center>
	  <a href='Principal.php?link=link52'>
