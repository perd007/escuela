...
$query_historial4 = "SELECT * FROM historial  where id_alumno=$cedula and grado=4 and mencion='Ciencia' ";
...
//nombre y nota de la materia de castellano
$query_materias41 = "SELECT * FROM materia where nombre like 'castellano y literatura' and grado=4 and mencion='Ciencia' ";
...
//nombre y nota de la materia de ingles
$query_materias42 = "SELECT * FROM materia where nombre like 'ingles' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de matematica
$query_materias43 = "SELECT * FROM materia where nombre like 'matematica' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de cienciaa biologicas
$query_materias44 = "SELECT * FROM materia where nombre like 'cienciaa biologicas' and grado=5 and mencion='Ciencia' ";
...
$query_materias45 = "SELECT * FROM materia where nombre like 'psicologia' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de historia de venezuela
$query_materias46 = "SELECT * FROM materia where nombre like 'historia de venezuela' and grado=5 and mencion='Ciencia' ";
...
$query_materias47 = "SELECT * FROM materia where nombre like 'instruccion premilitar' and grado=5 and mencion='Ciencia' ";
...
$query_materias48 = "SELECT * FROM materia where nombre like 'informatica' and grado=5 and mencion='Ciencia' ";
...
$query_materias49 = "SELECT * FROM materia where nombre like 'METODOLOGIA DE LA INVEST.' and grado=5 and mencion='Ciencia' ";
...
$query_materias410 = "SELECT * FROM materia where nombre like 'didactica' and grado=5 and mencion='Ciencia' ";
...
$query_materias411 = "SELECT * FROM materia where nombre like 'educacion ambiental' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de EDUC. FISICA Y DEPORTE
$query_materias412 = "SELECT * FROM materia where nombre like 'EDUC. FISICA Y DEPORTE' and grado=5 and mencion='Ciencia' ";
...
$query_materias413 = "SELECT * FROM materia where nombre like 'lecto escritura' and grado=5 and mencion='Ciencia' ";
...
$query_historial5 = "SELECT * FROM historial  where id_alumno=$cedula and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de castellano
$query_materias51 = "SELECT * FROM materia where nombre like 'castellano y literatura' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de ingles
$query_materias52 = "SELECT * FROM materia where nombre like 'ingles' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de matematica
$query_materias53 = "SELECT * FROM materia where nombre like 'matematica' and grado=5 and mencion='Ciencia' ";
...
$query_materias54 = "SELECT * FROM materia where nombre like 'literatura venezolana' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de historia de venezuela
$query_materias55 = "SELECT * FROM materia where nombre like 'historia de venezuela' and grado=5 and mencion='Ciencia' ";
...
$query_materias56 = "SELECT * FROM materia where nombre like 'geografia economica' and grado=5 and mencion='Ciencia' ";
...
$query_materias57 = "SELECT * FROM materia where nombre like 'psicologia evolutiva' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de informatica
$query_materias58 = "SELECT * FROM materia where nombre like 'informatica' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de instruccion premilitar
$query_materias59 = "SELECT * FROM materia where nombre like 'instruccion premilitar' and grado=5 and mencion='Ciencia' ";
...
$query_materias510 = "SELECT * FROM materia where nombre like 'cultura indigena' and grado=5 and mencion='Ciencia' ";
...
//nombre y nota de la materia de EDUC. FISICA Y DEPORTE
$query_materias511 = "SELECT * FROM materia where nombre like 'EDUC. FISICA Y DEPORTE' and grado=5 and mencion='Ciencia' ";
...
$query_materias512 = "SELECT * FROM materia where nombre like 'legislacion educativa' and grado=5 and mencion='Ciencia' ";
...
$query_materias513 = "SELECT * FROM materia where nombre like 'pre pasantia' and grado=5 and mencion='Ciencia' ";
...
style='font-size:11.0pt;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;' lang="es" xml:lang="es">
    ...
    ES-VE' lang="ES-VE" xml:lang="ES-VE">Menci&oacute;n:</span></b><u><span style='font-size:8.0pt;
    font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE"><span
    style='mso-spacerun:yes'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>CIENCIA_______</span></u><b
    style='mso-bidi-font-weight:normal'><span style='font-size:8.0pt;
    font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:ES-VE' lang="ES-VE" xml:lang="ES-VE">
              <o:p></o:p>
          </span></b></p></td>
