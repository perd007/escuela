...
<body>
<p>&nbsp;</p>
<form method="get" name="form2" onSubmit="return validar()" action="generarNotasCert2.php" target="_blank">
  <table width="280" border="1" align="center">
       <tr>
         <th colspan="2" bgcolor="#b50f0f" scope="col"><span class="Estilo1">Notas Certificadas </span></th>
       </tr>
       <tr>
       ...
       <tr>
         <td colspan="2" bgcolor="#b50f0f"><div align="center" class="Estilo3">
             <input name="Submit" type="submit" class="Estilo3" id="Submit" value="Buscar" />
             <input type="hidden" name="MM_insert" value="form1" />
			 <input type="hidden" name="link" value="link83" />
