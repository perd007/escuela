...
<form id="form1" name="form1" method="get" onsubmit="return validar()" action="principal.php">
  <p>&nbsp;</p>
  <table width="449" class="border" border="0" align="center" cellspacing="5">
    <tr>
      <th colspan="2" bgcolor="#b50f0f" align="center" scope="row"><span class="Estilo2">Carga de Asistencias</span> </th>
    </tr>
    <tr>
    ...
    <tr>
      <th colspan="2" align="center" bgcolor="#b50f0f" scope="row"><label>
        <input name="Submit" type="submit" class="Estilo3" value="siguiente" />
		<input type="hidden" name="link" value="link92" />
      </label></th>
    </tr>
  </table>
</form>
