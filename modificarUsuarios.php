...
<form method="post" name="form1" onSubmit="return validar()" action="<?php echo $editFormAction; ?>">
  ...
  <table align="center" class="border">
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#b50f0f"><div align="center" class="Estilo1">Modificacion de Usuarios </div></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#b50f0f"><div align="center" class="Estilo1">Permisos</div></td>
    </tr>
    <tr valign="baseline">
...
Administar </span></td>
    ...
    <tr valign="baseline">
      <td colspan="2" align="right" nowrap bgcolor="#b50f0f"><div align="center" class="Estilo5">
