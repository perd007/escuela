...
<form id="form1" name="form1" method="post" onSubmit="return validar()"  action="<?php echo $editFormAction; ?>">
  <p>&nbsp;</p>
  <table width="366" border="0" align="center" class="border" cellspacing="0">
    <tr bgcolor="#00CCFF" >
      <td colspan="2" bgcolor="#b50f0f" scope="row"><div align="center" class="Estilo17">Registro de Usuarios </div></td>
    </tr>
    <tr bgcolor="#00CCFF" >
    ...
    <tr>
      <td colspan="2" bgcolor="#b50f0f" scope="row"><div align="right">
