                              ...
                              <tbody>
                                <tr>
                                  <td colspan="2"><map name="Map">
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" width="97%">
                                        <tbody>
                                          <tr valign="top">
                                            <td width="720" height="62" valign="top"><div align="center"><img src="imagenes/banner_c11.jpg" width="570" height="62" usemap="#MapMap" border="0" />
                                ...
                                <tr>
                                  ...
                                  <td width="574" style="padding-top:5px;"><!-- Columna de Contenido Central -->
                                      <!-- Fin de Columna de Contenido Central --><form id="form1" name="form1" onsubmit="return validar()" method="post" action="<?php echo $editFormAction; ?>">
                                        <p>&nbsp;</p>
                                        <p>&nbsp;</p>
                                        <table width="41%" border="0" align="center" cellpadding="0" cellspacing="0">
                                          <tr bgcolor="#FFFFFF">
                                            <th colspan="2" scope="col"><img src="imagenes/imgTabla.jpg" width="308" height="20" /></th>
                                          </tr>
                                          <tr bgcolor="#CCCCCC">
                                            <th colspan="2" bgcolor="#fdf89d" scope="col"><span class="Estilo1">Ingreso al Sistema</span> </th>
                                          </tr>
                                          <tr bgcolor="#CCCCCC">
                                            <td width="33%" bgcolor="#fdf89d"><div align="right" class="Estilo1">Usuario:</div></td>
                                            <td width="67%" bgcolor="#fdf89d"><label>
                                              <input name="usuario" type="text" id="usuario" maxlength="10" />
                                            </label></td>
                                          </tr>
                                          <tr bgcolor="#CCCCCC">
                                            <td bgcolor="#fdf89d"><div align="right" class="Estilo1">Clave:</div></td>
                                            <td bgcolor="#fdf89d"><input name="clave" type="password" id="clave" maxlength="10" /></td>
                                          </tr>
                                          <tr bgcolor="#CCCCCC">
                                            <td height="28" colspan="2" bgcolor="#fdf89d"><div align="center">
                                                <input type="submit" name="Submit2" value="Validar" />
                                            </div></td>
                                          </tr>
                                          <tr bgcolor="#FFFFFF">
                                            <td height="28" colspan="2"><img src="imagenes/imgTabla2.jpg" width="308" height="20" /></td>
                                          </tr>
                                        </table>
                                        <p>
