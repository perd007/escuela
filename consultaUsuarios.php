...
.Estilo11 {color: #000000; font-size: 12px; }
.Estilo13 {
	color: #FFFFFF;
	font-size: 14px;
	font-weight: bold;
...
<body>
<p>&nbsp;</p>
<table class="border" width="572" border="0" cellpadding="0" cellspacing="0">
  <tr bgcolor="#00CCFF">
    <th colspan="9" bgcolor="#b50f0f" ><div class="Estilo13">Usuarios</div></th>
  </tr>
  <tr>
  ...
  <tr bgcolor="#00CCFF">
    <td width="86" bgcolor="#b50f0f"><span class="Estilo1">Usuario</span></td>
    <td width="70" bgcolor="#b50f0f"><span class="Estilo1">Clave</span></td>
    <td width="66" bgcolor="#b50f0f"><div align="center" class="Estilo1">Modificar</div></td>
    <td width="56" bgcolor="#b50f0f"><div align="center" class="Estilo1">Eliminar</div></td>
    <td width="64" bgcolor="#b50f0f"><div align="center" class="Estilo1">Registrar</div></td>
    <td width="65" bgcolor="#b50f0f"><div align="center"class="Estilo1" >Consultar</div></td>
    <td width="79" bgcolor="#b50f0f"><div align="center"class="Estilo1" >Administrar</div></td>
    <td width="64" bgcolor="#b50f0f"><div align="center" class="Estilo1">Op1</div></td>
    <td width="22" bgcolor="#b50f0f"><div align="center"class="Estilo1" >Op2</div></td>
  </tr>
  <?php do { 
  	$m=$row_usu["modificar"];
$r=$row_usu["registrar"];
...
$a="no";
  ...
  <tr bgcolor="<?php echo $color; ?>" >
      ...
      <td><span class="Estilo11"><?php echo "<a href='Principal.php?link=link72&cod=$row_usu[id_seg]'>Modificar</a>"; ?></span></td>
      <td><span class="Estilo11"><?php echo "<a onClick='return validar()' href='Principal.php?link=link73&id=$row_usu[id_seg]'>Eliminar</a>"; ?></span></td>
