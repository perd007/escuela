...
if($totalRows_historial>0){
 		echo "<script type=\"text/javascript\">alert ('Este alumno ya esta registrado en ". $_POST['grado'] ." Año '); location.href='Principal.php?link=link5' </script>";
  		exit;
}
...
//validar que quinto y sexto años sean los mismos que cuarto
if($_POST['grado']>4){
...
echo "<script type=\"text/javascript\">alert ('La mencion que tiene este alumno no coincide con la que registro para cuarto año'); location.href='Principal.php?link=link5' </script>";
exit;
	}
