...
<body>
<form method="post" name="form2" onSubmit="return validar()" action="constanciainscripcion.php" target="_blank">
  <p>&nbsp;</p>
  <table width="280" border="1" align="center">
    <tr>
      <th colspan="2" bgcolor="#b50f0f" scope="col"><span class="Estilo1">Constancia de Inscripcion </span></th>
    </tr>
    <tr>
